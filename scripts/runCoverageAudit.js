...
fs.mkdirSync("audit_outputs", { recursive: true });
fs.writeFileSync(
  "audit_outputs/coverage_audit_output.json",
  JSON.stringify(output, null, 2)
);

console.log("\n=== SUMMARY ===");
console.log("Total rows:", output.dataset.totalRows);
console.log("Total segments:", output.dataset.totalSegments);
console.log("Exact-friendly:", output.dataset.exactFriendlySegments);
